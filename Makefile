...
spm-c++: spm.o kernel.o theta.o moments.o Particle.o m_in.o mfa_params.o random.o
	${COMPILER} -o ${TARGET} ${FLAGS} spm.o kernel.o theta.o moments.o Particle.o m_in.o mfa_params.o random.o
